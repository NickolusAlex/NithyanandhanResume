...
import { GetApp as DownloadIcon, LinkedIn as LinkedInIcon, Call as MobileIcon, LocationOn as LocationIcon, Mail as MailIcon, MenuBook as MenuBookIcon, School as SchoolIcon, CheckCircleOutlineRounded as MarkIcon, EventRounded as PassoutDate, GitHub as GitHubIcon } from '@material-ui/icons';
// import CheckCircleOutlineRoundedIcon from '@material-ui/icons/CheckCircleOutlineRounded';
// import GitHubIcon from '@mui/icons-material/GitHub';

import './home.css';
// import { Document, Page } from 'react-pdf';
import ResumePdf from './NithyanandhanResume.pdf';
...
const home = () => {
    ...
    const userValue = {
        ...
        github: 'https://github.com/NickolusAlex'
    ...
    return (
        ...
        <div className="box">
            <div className="box-content">
                ...
                <Row className="">
                    <Col xs={4} md={4} sm={12} className="separation bio" >
                        <br />
                        ...
                        <div className="resume_address">
                            <GitHubIcon className="job_date_icon" /> <a target="_blank" rel="nofollow noreferrer" href={userValue.github}>github.com/NickolusAlex</a>
                        </div>

                        <div className="left_resume_content">
                            <div className="resume_heading">Objective</div>
                            <div className="resume_body">
                                &nbsp;To Secure a responsible career opportunity in a reputed organization to fully utilize my training and skills, while making a significant contribution to the success of the company.
                            </div>
                        </div>
                    ...
                    <Col xs={8} md={8} sm={12} className="separation records" >
                        <br />
                                ...
                                <ul className="experience_list">
                                    ...
                                    <li>
                                        <Row className="job_company">
                                            ...
                                            <Col xs={1} md={4} sm={6} className="job_date" >
                                                < PassoutDate className="job_date_icon" />    October, 2020 - November, 2021
                                            </Col>
                                        </Row>
                                        <Row className="job_title">
                            ...
                            <div className="records_content">
                                <ul className="projects_list" >
                                    ...
                                    <li>
                                        <Row className="project_name">
                                            <Col xs={11} md={9} sm={8} >
                                                JCI Blood Bank "Android Applicaion"
                                            </Col>
                                            <Col xs={1} md={3} sm={4} className="job_date" >
                                                Completed In 1 Month
                                            </Col>
                                        ...
                                        <Row className="job_discription">
                                            <Col offset={1}>
                                                It was a Cordova Andorid application developed for JCI working as a platform to post and inform the need for Blood donation.
                                            </Col>
                                        </Row>
                                    </li>
                                </ul>
                        ...
                        <div className="records_body">
                            <div className="records_heading">Certificate & Course</div>
                            <div className="records_content">
                                <ul className="interest_list">
                                    <li>Completed the course "Software Testing" in NPTEL Jan-Feb 2020</li>
                                    <li>Completed the course "Introduction to cybersecurity" in Cisco Networking Academy August 2021.</li>
                                </ul>
                            </div>
                        </div>
